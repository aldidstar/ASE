...
$pdf =& new Cezpdf('A1','portrait');
		...
		$pdf->ezText('Tanaman Hias.com', 25, array('justification' => 'center'));
		$pdf->ezText('LAPORAN DATA PRODUK', 15, array('justification' => 'center'));
		$pdf->ezText('PEMBELIAN TANAMAN HIAS', 15, array('justification' => 'center'));
		$pdf->ezSetDy(-10);
		$pdf->ezText('Tanaman Hias.com', 12, array('justification' => 'center'));
		$pdf->ezText('Jl. Telaga Bestari No. 33 B5-B6 Balaraja', 10, array('justification' => 'center'));
		$pdf->ezText('Tanaman Hias.com / Telp : 0813 1111 2222 ', 10, array('justification' => 'center'));
