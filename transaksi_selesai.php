...
<tr>
  ...
  <td width="400" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Area_Informasi">
    ...
    <tr>
      <th colspan="2" align="left" valign="top">Mohon konfirmasi via sms / whatsapp ke nomor 0813 1111 2222 setelah Anda melakukan pembayaran, dengan <br />
        <br />
    ...
    <tr>
      <th colspan="2" align="left" valign="top"><strong>Pesanan akan kami cancel apabila dalam 2x24 jam belum kami terima pembayarannya.</strong><br />
        ...
        <br />
        <strong>Nama Pemilik Rekening: <span class="Teks_Transaksi">Tanaman Hias.com</span></strong><br />
        <br />
        <strong>BCA</strong><br />
        Norek: <span class="Teks_Bank"></span><br />
        Cabang: Balaraja<br />
        <br />
...
<td width="200" align="left" valign="top" bgcolor="#E8EED7"><div class="Area_Menu_Kiri">
  <table width="100%" border="0" cellspacing="2" cellpadding="0">
    ...
    <tr>
      <th colspan="2" align="center" valign="top" class="Teks_Bank" scope="col">Tanaman Hias.com</th>
    </tr>
    <tr>
