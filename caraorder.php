...
<title>Tanaman Hias Online</title>
...
<br /></td>
    ...
    <th width="400" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Area_Produk">
      ...
      <tr>
        <td align="left" valign="top"><p class="Teks_Informasi">Cara berbelanja di Tanaman Hias.com sangat mudah. Bacalah petunjuk di bawah ini dan Anda siap untuk berbelanja :)</p>
          ...
          <p class="Teks_Informasi">Cara pembayaran dilakukan dengan sistem transfer melalui bank BCA, Mandiri atau Niaga. Nomor rekening akan kami beritahukan pada saat sms / whatsapp konfirmasi kami kirimkan.</p>
          ...
          <p class="Teks_Informasi">TANAMAN HIAS</p>
    ...
    <td width="200" align="left" valign="top" bgcolor="#E8EED7"><div class="Area_Menu_Kanan">
        <table width="100%" border="0" cellspacing="2" cellpadding="0">
          ...
          <tr>
            ...
            <td align="left" valign="top" class="Teks_Informasi" scope="col">CS Online : 0813 1111 2222<br />       <br /></td>
          </tr>
          <!--<tr>
          ...
          <tr>
            <td colspan="2" align="center" valign="top" class="Teks_Bank" scope="col">Tanaman Hias.com</td>
          </tr>
          <tr>
